...
export default function BookingCTA() {
    const whatsappMsg = encodeURIComponent("Hello, I'd like to book a room at DJ Imperial Suites.");
    return (
        <section id="book" className="booking-cta">
            <div className="booking-overlay"></div>
            <div className="container booking-inner">
                <h2 className="booking-title">Book Your Stay Today</h2>
                <p className="booking-text">
                    Experience comfort, luxury, and delicious dining at DJ Imperial Suites.
                    <br />Call us or drop a WhatsApp message — we&apos;re happy to help!
                </p>
                <div className="booking-phones">
                    <a href="tel:9995703313" className="phone-chip">📞 9995 70 3313</a>
                    <a href="tel:9995803313" className="phone-chip">📞 9995 80 3313</a>
                </div>
                <div className="booking-buttons">
                    <a href="tel:9995703313" className="btn booking-btn-primary">Call Now</a>
                    <a href="https://wa.me/919995703313?text=${whatsappMsg}" target="_blank" rel="noopener noreferrer" className="btn booking-btn-whatsapp">
                    ...
                    <Link href="#suites" className="btn btn-outline cta-outline">Book a Room</Link>
                </div>
            </div>
        </section>
    );
